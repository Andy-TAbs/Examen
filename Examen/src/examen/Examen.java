...
//DECLARACION DE VARIABLES
        Scanner sc = new Scanner(System.in); // sc servira para leer lo que se ponga en consola
        String mensaje;
        ...
        if(eleccion == 1){ // en caso de seleccionar continuar
            ...
            switch(numero){// Dependiendo del numero, se dirigira a un jugador u otro
                case 1: 
                ...
                case 11:
                    ...
                    break;                
                default: // Si no se introduce un valor apropiado te manda el mensaje
